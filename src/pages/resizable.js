      ...
      <div className="relative flex min-h-full flex-col">
        ...
        <div className="mx-auto w-full max-w-7xl flex-grow lg:flex xl:px-8">
          ...
          <Resizable
            ...
            className="hidden md:flex flex-col pl-8 rounded-md rounded-r-none  border-r-2 border-neutral-200 dark:border-neutral-700 hover:border-neutral-400 dark:hover:border-neutral-600 transition-all duration-300 bg-gray-50 lg:flex-shrink-0 lg:border-l lg:border-gray-200 lg:pr-8 xl:pr-0"
          >
